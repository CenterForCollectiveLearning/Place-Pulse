...
function startPopulatingPlace(_placeID, polygonStr, dataResolution, locDistribution, points_to_add) {
...
function processSVData(data, status)
{
  //console.log('processSVData');
    ...
    console.log('streetview service error.');
  }
...
function endplacePopulation() {
  //console.log('endplacePopulation');
		    $.ajax({
		        dataType: 'json',
